            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    <a href="{{ route('products.index') }}"
                        class="{{ request()->is('products*') ? 'bg-[#9e4444] text-white' : 'text-gray-100' }} hover:bg-[#be6f6f] hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                        Produk
                    </a>
                    <a href="{{ route('categories.index') }}"
                        class="{{ request()->is('categories*') ? 'bg-[#9e4444] text-white' : 'text-gray-100' }} hover:bg-[#be6f6f] hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                        Kategori
                    </a>
                    <a href="{{ route('inventory-logs.index') }}"
                        class="{{ request()->is('inventory-logs*') ? 'bg-[#9e4444] text-white' : 'text-gray-100' }} hover:bg-[#be6f6f] hover:text-white px-3 py-2 rounded-md text-lg font-medium">
                        Log Inventaris
                    </a>
                </div>
            </div>
