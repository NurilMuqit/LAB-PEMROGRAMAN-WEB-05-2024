...
@section('content')
    <div class="max-w-7xl mx-auto px-4 lx:px-6 lg:px-8 mt-8">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-5xl font-bold text-[#9a4343]">Manajemen Kategori</h2>
            <a href="{{ route('categories.create') }}" style="padding: 10px; background-color: #9a4343; border-radius: 10px; color: #fff; transition: background-color 0.3s;"
            onmouseover="this.style.backgroundColor='#a52b2b';"
            onmouseout="this.style.backgroundColor='#9a4343';">
            <i class="fas fa-plus"></i>Kategori</a>
        </div>

        <div class="bg-white shadow overflow-hidden lx:rounded-md [--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px]  rounded-2xl [box-shadow:var(--shadow)]">
            <div class="px-4 py-5 lx:px-6">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <!-- Center text in table header -->
                            <th class="px-6 py-3 text-center text-lx font-large text-[#9a4343] uppercase tracking-wider">
                                Nama
                            </th>
                            <th class="px-6 py-3 text-center text-lx font-large text-[#9a4343] uppercase tracking-wider">
                                Deskripsi
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap  text-lx font-medium">
