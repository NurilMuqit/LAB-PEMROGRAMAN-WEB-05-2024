        ...
        <div
            ...
            <div class="px-4 py-3 sm:px-6">
                <div class="flex justify-center">
                    <h2 class="text-2xl font-bold text-[#8e2525] text-center mb-0">Tambah Log Inventaris</h2>
                </div>
                <form action="{{ route('inventory-logs.store') }}" method="POST">
                    ...
                    <div class="flex justify-between mt-3">
                        <a href="{{ route('inventory-logs.index') }}"
                            class="py-2 px-6 bg-[#d32323] rounded-l-lg text-white text-center flex-1 mx-1 hover:bg-[#b94646] transition-all duration-300">Batal</a>
                        <button type="submit"
                            class="py-2 px-6 bg-[#319e52] rounded-r-lg text-white text-center flex-1 mx-1 hover:bg-[#69f794] transition-all duration-300">Buat Log Inventaris</button>
                    </div>
                </form>
            </div>
        </div>
