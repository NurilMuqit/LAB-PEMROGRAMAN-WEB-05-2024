...
<br>
    <div
        class="bg-white shadow overflow-hidden sm:rounded-md [--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] m-auto w-4/5 h-auto rounded-2xl [box-shadow:var(--shadow)] max-w ">
        <div class="px-4 py-5 sm:px-6">
            <div class="flex justify-center">
                <h2 class="text-4xl font-bold text-[#8e2525] text-center">Edit Produk</h2>
            </div>
            <form action="{{ route('products.update', $product) }}" method="POST">
                ...
                <div class="flex justify-between">
                    <a href="{{ route('products.index') }}"
                        class="py-2 px-6 bg-[#d32323] rounded-l-lg text-white text-center flex-1 mx-1 hover:bg-[#b94646] transition-all duration-300">
                        Batal
                    </a>
                    <button type="submit"
                        class="py-2 px-6 bg-[#319e52] rounded-r-lg text-white text-center flex-1 mx-1 hover:bg-[#69f794] transition-all duration-300">
                        Perbarui Produk
                    </button>
                </div>
            </form>
