...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-5xl font-bold text-[#8e2525]">Manajemen Produk</h2>
            <a href="{{ route('products.create') }}"
                style="padding: 10px; background-color: #9a4343; border-radius: 10px; color: #fff; transition: background-color 0.3s;"
        ...
        <div
            class="bg-white shadow overflow-hidden sm:rounded-md [--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px]  rounded-2xl [box-shadow:var(--shadow)]">
